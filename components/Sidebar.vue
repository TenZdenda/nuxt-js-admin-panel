  ...
  >
    ...
    <nav class="space-y-4">
      ...
      >
        ...
        <span class="font-semibold text-md">Dashboard</span>
      </nuxt-link>
      <nuxt-link
        to="/admin/users"
        class="
      ...
      >
        ...
        <span class="font-semibold text-md">Students</span>
      </nuxt-link>
      <nuxt-link
        to="/admin/courses"
        class="
      ...
      >
        ...
        <span class="font-semibold text-md">Courses</span>
      </nuxt-link>
      <nuxt-link
        to="/admin/staff"
        class="
      ...
      >
        ...
        <span class="font-semibold text-md">Staff</span>
      </nuxt-link>
      <nuxt-link
        to="/admin/settings"
        class="
